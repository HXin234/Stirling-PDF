  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      merge: {
        ...
        component: Merge,
        description: t("home.merge.desc", "Combine multiple PDF files into a single document while preserving page order and formatting"),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: -1,
      ...
      addPassword: {
        ...
        description: t("home.addPassword.desc", "Protect PDFs with password encryption and set user/owner permissions to control printing and copying"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
      ...
      sanitize: {
        ...
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_SECURITY,
        description: t("home.sanitize.desc", "Remove metadata, scripts, and embedded objects that may contain sensitive information or security threats"),
